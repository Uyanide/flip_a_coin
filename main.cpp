...
HWND creat_window_boarderless(HINSTANCE hInstance, const wchar_t* class_name, const wchar_t* window_name, int width, int height);
	...
	_In_ int nShowCmd)
{
	try
	{
		HWND hwnd = creat_window_boarderless(hInstance, L"coin", L"coin", 480, 480);
